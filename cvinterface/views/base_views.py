...
class DefaultRequestUpdateView(SuccessMessageMixin, UpdateView):
    ...
    def form_valid(self, form):
        email_subject = 'WAMDAM1 Controlled Vocabularies - Submission Update'
...
class DefaultRequestCreateView(SuccessMessageMixin, CreateView):
    ...
    def send_confirmation_email(self, form):
        ...
        submitter_email_subject = 'WAMDAM1 Controlled Vocabularies Submission'
        submitter_email_message = ''.join(['Thank you for your submission to WAMDAM1 Controlled Vocabularies.', linesep, linesep,
        ...
        admins_email_subject = 'New request for an WAMDAM1 Controlled Vocabulary Term'
